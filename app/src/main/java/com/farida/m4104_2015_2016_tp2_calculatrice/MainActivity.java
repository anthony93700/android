...
private ParseurMath p;
	...
	public void initConnection() {
		...
		button.setTag(button.getText().toString());
		button.setOnClickListener(new EcouteurBouton());
		button = (Button) this.findViewById(R.id.btn_2);
		button.setTag(button.getText().toString());
		button.setOnClickListener(new EcouteurBouton());
	...
	protected void onRestoreInstanceState(Bundle savedInstanceState) {
			...
			this.a = savedInstanceState.getString(this.a);
			this.afficheur = (TextView) findViewById(R.id.textView1);
			this.afficheur.setText(this.a);
	...
	protected void onSaveInstanceState(Bundle outState) {
			...
			this.afficheur = (TextView) findViewById(R.id.textView1);
		outState.putString(this.a, (String) this.afficheur.getText());
